...
* **Return type:**
  [`RubricVerdict`](aix.vision.md#aix.vision.RubricVerdict) | [`None`](https://docs.python.org/3/builtins/constants.html#None)
...
* **Return type:**
  [`GeneratedVideo`](aix.video.md#aix.video.GeneratedVideo)
* **Returns:**
...
* **Return type:**
  [`ImageComparison`](aix.vision.md#aix.vision.ImageComparison)
* **Returns:**
...
* **Return type:**
  [`AixConfig`](aix.config.md#aix.config.AixConfig)
...
* **Parameters:**
  ...
  * **\*\*kwargs** – Additional provider-specific parameters
* **Return type:**
  `Union`[[`GeneratedImage`](aix.image.md#aix.image.GeneratedImage), [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`GeneratedImage`](aix.image.md#aix.image.GeneratedImage)]]
* **Returns:**
...
* **Parameters:**
  ...
  * **\*\*kwargs** – Additional provider-specific parameters
* **Return type:**
  [`GeneratedImage`](aix.image.md#aix.image.GeneratedImage)
* **Returns:**
...
* **Parameters:**
  ...
  * **\*\*kwargs** – Additional provider-specific parameters
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`GeneratedImage`](aix.image.md#aix.image.GeneratedImage)]
* **Returns:**
...
* **Parameters:**
  ...
  * **\*\*kwargs** – Additional provider-specific parameters
* **Return type:**
  [`GeneratedAudio`](aix.audio.md#aix.audio.GeneratedAudio)
* **Returns:**
...
* **Return type:**
  `Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`TranscriptionResult`](aix.audio.md#aix.audio.TranscriptionResult)]
* **Returns:**
...
* **Return type:**
  [`TranscriptionResult`](aix.audio.md#aix.audio.TranscriptionResult)
* **Returns:**
...
* **Return type:**
  [`Iterator`](https://docs.python.org/3/library/typing.html#typing.Iterator)[[`AixConfig`](aix.config.md#aix.config.AixConfig)]
...
| [`config`](aix.config.md#module-aix.config)           | Central configuration for AIX (single source of truth for defaults).   |
|-------------------------------------------------------------------------------------|------------------------------------------------------------------------|
| [`ai_models`](aix.ai_models.md#module-aix.ai_models)     | AI Model Management Module.                                            |
| [`audio`](aix.audio.md#module-aix.audio)             | Audio operations interface for AIX.                                    |
| [`batches`](aix.batches.md#module-aix.batches)         | Batch processing interface for AIX.                                    |
| [`credentials`](aix.credentials.md#module-aix.credentials) | Unified, discoverable API-key / secret resolution for AIX.             |
| [`gen_ai`](aix.gen_ai.md#module-aix.gen_ai)           | Generative AI modules.                                                 |
| [`image`](aix.image.md#module-aix.image)             | Image generation interface for AIX.                                    |
| [`misc`](aix.misc.md#module-aix.misc)               | Misc AIX functions.                                                    |
| [`models`](aix.models.md#aix.models)                  | User-friendly interface for model discovery and selection.             |
| [`prompts`](aix.prompts.md#module-aix.prompts)         | Prompt-based function creation for AIX.                                |
| [`stores`](aix.stores.md#module-aix.stores)           | Storage layers for AIX.                                                |
| [`util`](aix.util.md#module-aix.util)               | Utils for AIX.                                                         |
| [`video`](aix.video.md#module-aix.video)             | Video generation interface for AIX.                                    |
| [`vision`](aix.vision.md#module-aix.vision)           | Image-to-text (vision) interface for AIX.                              |
